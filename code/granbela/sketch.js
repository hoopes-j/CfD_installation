...
function setup() {
	...
	speedSlider = createSlider(0, 4000, 1000);
	grainSizeSlider = createSlider(0, 2000, 1143);
	filePosSlider = createSlider(0,4000,1243);
	grainOffsetSlider = createSlider(0,4000,4000);
	spraySlider = createSlider(0,1000,804);

	//Text
	speedLabel = createP("ppeed");
	grainSizeLabel = createP("grain duration [seconds]:");
...
function draw() {
	...
	buffer[1]=grainSizeSlider.value()/1000;
